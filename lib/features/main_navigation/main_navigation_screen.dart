...
class _MainNavigationScreenState extends State<MainNavigationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        // 메모 : Stack = Widget들을 하나씩 쌓을 때 사용하는 위젯
        children: [
          // 메모 : Offstate 위젯을 너무 많이 사용하면 모든 children들이 동시에 활성화되어 render되기 떄문에 느려질 수 잇음
          Offstage(
            // 메모 : child에 들어있는 위젯을 만들지만(렌더링하지만) 보이지 않게 함
            offstage:
                _selectedIndex != 0, // 메모 : true면 화면에서 숨겨줌 & false면 화면에 보임
